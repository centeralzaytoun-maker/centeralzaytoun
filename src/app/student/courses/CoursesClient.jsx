                        ...
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            >
                                {centerType === 'instructor'
                                    ? (centerSettings?.instructor_name ? `أ/ ${centerSettings.instructor_name}` : 'Instructor Platform')
                                    : (centerSettings?.center_name || 'Nexus Academy')}
                            </div>
                        ...
                        <div className="flex items-center gap-6 mb-4">
                            <h1 className="text-4xl md:text-6xl font-black text-white leading-tight">
                                ...
                                <span
                                    ...
                                    style={{ backgroundImage: `linear-gradient(to right, ${primaryColor}, ${centerSettings?.secondary_color || '#6366f1'})` }}
                                >
                                    الرقمية
                                </span>
                            </h1>
            ...
            >
                <div className="relative h-72 overflow-hidden">
                    {course.thumbnail_url ? (
                        <>
                            <img src={course.thumbnail_url} alt={course.name} className="w-full h-full object-cover object-top transition-transform duration-1000 group-hover:scale-110" />
                    ...
                    {examsCount > 0 && (
                        <div className="absolute top-4 left-4 px-3 py-1.5 bg-amber-500/90 backdrop-blur-md rounded-xl text-[10px] font-black text-white shadow-lg">
                            {examsCount} امتحان
                        </div>
                    )}
                </div>
                ...
                <div className="p-8 flex-1 flex flex-col">
                    <div className="flex justify-between items-start mb-6">
                        ...
                        <div className="flex flex-col items-end">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-2xl font-black text-red-600">{course.digital_full_price || 0} <span className="text-xs">جنيه</span></span>
                            </div>
                    ...
                    <div className="mt-auto space-y-3">
                        {isEnrolled ? (
                            ...
                            <>
                                <Link href={`/student/courses/${course.id}`} className="w-full h-14 bg-white border-2 border-red-500 text-red-600 rounded-2xl font-black text-sm flex items-center justify-center hover:bg-red-50 transition-all">
                                    الدخول للكورس
                                </Link>
                                <Link href={`/student/checkout/${course.id}`} className="w-full h-14 bg-red-600 text-white rounded-2xl font-black text-sm flex items-center justify-center shadow-lg shadow-red-900/20 hover:bg-red-700 transition-all active:scale-95">
                                    الإشتراك في الكورس !
                                </Link>
                            </>
                        )}
